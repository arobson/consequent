require( "../setup" );
var eventAdapterFn = require( "../../src/events" );
...
describe( "Events", function() {
	...
	describe( "when fetching events", function() {
		describe( "and events are returned from cache", function() {
			var storeMock, cacheMock, events;
			before( function() {
			...
			it( "should return events", function() {
				return eventAdapter.fetch( "account", 10, 100 )
			...
			it( "should call getEventsFor on cache", function() {
				cacheMock.verify();
			} );

			it( "should not call store", function() {
				storeMock.verify();
			} );
		} );

		describe( "and cache returns an error", function() {
			var storeMock, cacheMock, events;
			before( function() {
				events = [ { id: 3 }, { id: 1 }, { id: 2 } ];
			...
			it( "should return events", function() {
				return eventAdapter.fetch( "account", 10, 100, true )
					.should.eventually.eql( [
						{ id: 1 },
						{ id: 2 },
						{ id: 3 }
			...
			it( "should call getEventsFor on store", function() {
				storeMock.verify();
			} );
		} );

		describe( "and no events are in cache", function() {
			describe( "and events are returned from store", function() {
				var storeMock, cacheMock, events;
				before( function() {
					events = [ { id: 3 }, { id: 1 }, { id: 2 } ];
			...
			describe( "and store returns an error", function() {
				var storeMock, cacheMock, events;
				before( function() {
					storeMock = sinon.mock( store );
					cacheMock = sinon.mock( cache );
			...
			describe( "and no events are in store", function() {
				var storeMock, cacheMock, events;
				before( function() {
					storeMock = sinon.mock( store );
					cacheMock = sinon.mock( cache );
	...
	describe( "when fetching eventpack", function() {
		describe( "and eventpack is returned from cache", function() {
			var storeMock, cacheMock, events;
			before( function() {
				events = [ { id: 3 }, { id: 1 }, { id: 2 } ];
			...
			it( "should return events", function() {
				return eventAdapter.fetchPack( "account", 10, "a:1;b:2" )
					.should.eventually.eql( [
						{ id: 1 },
						{ id: 2 },
						{ id: 3 }
		...
		describe( "and no eventpack is in cache", function() {
			describe( "and eventpack is returned from store", function() {
				var storeMock, cacheMock, events;
				before( function() {
					events = [ { id: 3 }, { id: 1 }, { id: 2 } ];
			...
			describe( "and no pack was in the store", function() {
				var storeMock, cacheMock, events;
				before( function() {
					events = [ { id: 3 }, { id: 1 }, { id: 2 } ];
	...
	describe( "when storing events", function() {
		describe( "when cache and store succeed", function() {
			var storeMock, cacheMock, events;
			before( function() {
				events = [];
				storeMock = sinon.mock( store );
			...
			it( "should call storeEvents on cache", function() {
				cacheMock.verify();
			} );

			it( "should call storeEvents on store", function() {
				storeMock.verify();
			} );
		} );
		...
		describe( "when cache fails", function() {
			...
			it( "should reject store with an error", function() {
				return eventAdapter.store( "account", 50, events )
		...
		describe( "when store fails", function() {
			...
			it( "should not call storeEvents on cache", function() {
				cacheMock.verify();
			} );
	...
	describe( "when storing eventpack", function() {
		describe( "when cache and store succeed", function() {
			var storeMock, cacheMock, loadedEvents, events;
			before( function() {
				events = [ { id: 2 }, { id: 3 } ];
			...
			it( "should call storeEventPack on cache", function() {
				cacheMock.verify();
			} );

			it( "should call storeEventPack on store", function() {
				storeMock.verify();
			} );
		} );

		describe( "when cache store fails", function() {
			var storeMock, cacheMock, loadedEvents, events;
			before( function() {
				events = [ { id: 2 }, { id: 3 } ];
				loadedEvents = [ { id: 1 }, { id: 2 } ];
			...
			it( "should reject storePack with cache error", function() {
				return eventAdapter.storePack( "account", 50, "a:1", 1, events )
		...
		describe( "when storing eventpack fails", function() {
			var storeMock, cacheMock, loadedEvents, events;
			before( function() {
				events = [ { id: 2 }, { id: 3 } ];
				loadedEvents = [ { id: 1 }, { id: 2 } ];
			...
			it( "should not call storeEventPack on cache", function() {
				cacheMock.verify();
			} );
		...
		describe( "when fetching events fails", function() {
			var storeMock, cacheMock, loadedEvents, events;
			before( function() {
				events = [ { id: 2 }, { id: 3 } ];
				loadedEvents = [ { id: 1 }, { id: 2 } ];
			...
			it( "should not call storeEventPack on store", function() {
				storeMock.verify();
			} );
		} );
	} );
